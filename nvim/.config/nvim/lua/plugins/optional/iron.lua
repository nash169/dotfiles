return {
	...
	config = function(plugins, opts)
		...
		vim.keymap.set("n", "<space>jm", "<cmd>IronFocus<cr>")
		vim.keymap.set("n", "<space>jh", "<cmd>IronHide<cr>")
	end,
}
